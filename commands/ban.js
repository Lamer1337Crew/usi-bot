...
exports.run = (client, message, args) => {
  ...
  let role = message.guild.member.highestRole.position;
  ...
  if (message.mentions.users.first().id === "482706815784714272") return message.channel.send("You can't ban my Developer:wink:");
