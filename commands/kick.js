...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.first().id === "482706815784714272") return message.reply("You can't kick my Developer:wink:");
  ...
  if  (!logchannel){
    message.channel.send(`:white_check_mark: Success! I have kicked the member`)
  }else{
